...
BOOL COIIIApp::InitInstance()
{
	...
	*/
	...
	/* spi 2014, migrated out of here, placed within user's derived class
...
CLogDocument* COIIIApp::GetLogDocument()
{
	...
	{ 
		...
		pLogDocument->SetTitle(L"Log Window");
		//2021fev08, spi, begin
		pLogDocument->EnableFileUpdating();
		//2021fev08, spi, end
	}
	return pLogDocument;	
}
...
CGotoPartitionDlg* COIIIApp::GetGotoPartitionDlg()
{
	...
	else
	{
		...
		{
			AfxMessageBox(L"pGotoPartitionDlg is NULL, see OIII.cpp");
			return NULL;
		}
		if(pGotoPartitionDlg->Create(IDD_GOTOPARTITION, m_pMainWnd) == FALSE)
		{
			AfxMessageBox(L"Problem creating GotoPartitionDlg, see OIII.cpp");
			return NULL;
		}
...
CGotoPartitionDlg* COIIIApp::GetGotoClassificationDlg()
{
	...
	else
	{
		...
		{
			AfxMessageBox(L"pGotoClassificationDlg is NULL, see OIII.cpp");
			return NULL;
		}
		...
		{
			AfxMessageBox(L"Problem creating GotoClassificationDlg, see OIII.cpp");
			return NULL;
		}
		pGotoClassificationDlg->SetWindowText(L"Goto Classification");
...
CSettingsSheet* COIIIApp::GetSettingsSheet()
{
	...
	else
	{
		...
		//create modeless dlg
		pSettingsSheet = (CSettingsSheet*) new CSettingsSheet(L"Settings", m_pMainWnd);
		if(pSettingsSheet==NULL) 
		{
			AfxMessageBox(L"pSettingsSheet is NULL, see OIII.cpp");
			return NULL;
		}
		...
		{
			AfxMessageBox(L"Problem creating pSettingsSheet, see OIII.cpp");
			return NULL;
		}
