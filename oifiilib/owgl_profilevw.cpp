...
IMPLEMENT_DYNCREATE(CProfileGraphView, COWGraphView)
           
BEGIN_MESSAGE_MAP(CProfileGraphView, COWGraphView)
...
void CProfileGraphView::OnMouseMove(UINT /*nFlags*/, CPoint /*point*/)
{
	return;     
} 